...
public class ListIteratorExample {
    ...
    public static void main(String[] args) {
        ...
        showList();
        //move 6
        System.out.println("6 - Move back over item "+ li.next());
        pos--;
        showList();
        //move 7
        System.out.println("7 - Deleting last item trevelled over");
        li.remove();
        showList();
        //move 8
        System.out.println("8 - Move back over item "+ li.next());
        pos--;
        showList();
        //move 9
        System.out.println("9 - set last item travelled over to e");
        li.set("e");
        showList();
        //move 10 & 11
        System.out.println("10 & 11 - Adding c and b back into left of iterator");
        li.add("b");
        pos++;
        li.add("c");
        pos++;
        showList();
        //move 12
        System.out.println("12 - try to remove but will cause error");
        ...
        showList();
        //move 13
        System.out.println("13 - Moving x past "+li.next());
        pos++;
        showList();
        //move 14
        System.out.println("Trying to move past end of list");
        try{
            li.next();
        }catch(Exception e){
